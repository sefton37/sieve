# No One Relevancy Rubric

## Purpose

This document is a reference for scoring news articles on their relevance to a set of interconnected analytical themes. Use it to evaluate each article and assign a relevance score that enables prioritized summarization. Articles with higher relevance scores should receive deeper analysis and earlier attention in any reporting pipeline.

The perspective described here is secular and systems-oriented. It examines how power, attention, autonomy, and cooperation function across technology, economics, governance, and culture. The name "No One" refers not to nihilism but to a design principle: systems should serve everyone without being captured by anyone.
...
## Keyword and Signal Mapping

Use these keyword clusters to accelerate initial triage against the article's `keywords` field before deeper content analysis.

### High-Signal Keywords

These keywords, when present in article keywords or summary, strongly suggest relevance:

- **Attention/extraction:** attention economy, engagement metrics, algorithmic feed, behavioral advertising, screen time, dopamine design, infinite scroll, dark patterns, persuasive technology
- **Sovereignty/rights:** data ownership, digital rights, cognitive sovereignty, informed consent, data portability, right to delete, surveillance, biometric, facial recognition, digital identity
- **Power/consolidation:** monopoly, antitrust, vertical integration, regulatory capture, oligopoly, market concentration, platform power, walled garden, gatekeeping, too big to fail
- **Coercion/cooperation:** cooperative, mutual aid, commons, open source, interoperability, decentralized, federated, community governance, collective bargaining, platform cooperativism
- **Fear/trust:** manufactured crisis, outrage, fearmongering, scarcity narrative, whistleblower, psychological safety, organizational fear, crisis exploitation, trust deficit
- **Democratization:** open source, local-first, right to repair, digital divide, community broadband, small model, edge computing, self-hosted, technology sovereignty
- **Systems/incentives:** incentive design, perverse incentive, unintended consequences, moral hazard, systemic risk, feedback loop, structural reform, institutional failure, governance architecture

### Context-Dependent Keywords

These require content-level analysis to determine relevance:

- **AI/ML:** Relevant when framed in terms of power, access, training data rights, labor displacement, or consolidation. Less relevant when purely technical benchmarking.
- **Regulation/legislation:** Relevant when addressing structural power dynamics. Less relevant when procedural or narrowly technical.
- **Climate/environment:** Relevant when framed as systemic design failure, commons governance, or intergenerational coercion. Less relevant as isolated weather reporting.
- **Healthcare:** Relevant when addressing access as sovereignty, pharmaceutical consolidation, or mental health as systemic outcome. Less relevant as clinical trial results without systemic framing.
- **Education:** Relevant when addressing knowledge democratization, institutional gatekeeping, or attention management. Less relevant as institutional rankings or scheduling.
- **Military/defense:** Relevant when addressing surveillance infrastructure, autonomous weapons governance, or state power consolidation. Less relevant as equipment procurement or tactical reporting.

### Low-Signal Keywords

These rarely indicate relevance on their own and should not elevate scoring without supporting content:

- Celebrity, entertainment, sports scores, product launch (without systemic framing), earnings report (without concentration analysis), weather, routine election coverage (without structural analysis), individual crime reporting

---

## Analysis Guidelines

When generating summaries for high-scoring articles, structure the analysis around these questions:

1. **What is being consolidated or distributed?** Identify whether the article describes concentration or dispersal of power, resources, access, or decision-making authority.

2. **Who bears the cost and who captures the value?** Trace the flow of attention, labor, data, or resources. Identify asymmetries between who produces value and who profits from it.

3. **What incentive structure is at work?** Look past individual actors to the system that shapes their behavior. What would a rational actor do given these incentives, regardless of moral intention?

4. **Is sovereignty expanding or contracting?** Determine whether the development increases or decreases the capacity of individuals and communities to make informed, uncoerced choices.

5. **What is the fear, and who benefits from it?** Identify any scarcity narrative, urgency framing, or threat construction, and trace who profits from the resulting compliance.

6. **What would invitation-based design look like here?** Consider what the non-coercive alternative would be — the system that achieves similar goals through voluntary participation and transparent incentives.

---

## Edge Cases and Calibration Notes

- **Technology optimism without structural analysis** should score low. Announcements of new capabilities matter only insofar as they shift power, access, or sovereignty.

- **Outrage framing without systemic context** should score low. Articles designed to provoke emotional reaction without illuminating structural dynamics are themselves examples of attention extraction, not analysis of it.

- **Individual hero or villain narratives** should score lower than structural analyses of the same events. The question is never "who did this" but "what system made this the rational thing to do."

- **Both-sides framing that obscures power asymmetry** should be noted. False balance between a consolidating power and those affected by consolidation is itself a structural phenomenon worth flagging.

- **International perspective matters.** The same dynamics of consolidation, extraction, and sovereignty play out across all geographies and political systems. Relevance is not limited to any single country or political tradition.

- **Positive developments score high too.** Articles about successful cooperative models, effective regulation, tools that expand access, or communities reclaiming sovereignty are just as relevant as articles about consolidation and extraction. The rubric measures proximity to the themes, not valence.

---

## Output Schema

For each scored article, produce:
